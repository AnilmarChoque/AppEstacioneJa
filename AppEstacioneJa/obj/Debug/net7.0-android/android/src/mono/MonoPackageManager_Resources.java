...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AppEstacioneJa.dll" comes first in this list. */
		"AppEstacioneJa.dll",
		"Microsoft.Maui.dll",
		...
		"Ark.Tools.ApplicationInsights.dll",
		"Ark.Tools.Core.dll",
		"Ark.Tools.NLog.dll",
		"Ark.Tools.Nodatime.dll",
		"Ark.Tools.Nodatime.SystemTextJson.dll",
		"Ark.Tools.Solid.dll",
		"Ark.Tools.Solid.FluentValidaton.dll",
		"Ark.Tools.SystemTextJson.dll",
		"Azure.Core.dll",
		"Azure.Identity.dll",
		"Ben.Demystifier.dll",
		"Ensure.That.dll",
